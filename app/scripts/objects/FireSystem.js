...
export default class ParticleSystem extends THREE.Object3D {
  constructor({ renderer, scene, alpha = 1 }) {
    super();
    ...
    this.positionShader = new THREE.ShaderMaterial({
      ...
      vertexShader: glslify('../shaders/fire/simulation.vert'),
      fragmentShader: glslify('../shaders/fire/position.frag'),
    });
    ...
    this.mat = new THREE.ShaderMaterial({
      ...
      vertexShader: glslify('../shaders/fire/index.vert'),
      fragmentShader: glslify('../shaders/fire/index.frag'),
